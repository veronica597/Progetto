/* File js associato a chartInside.html */
...
var ip = '192.168.1.67'; // indirizzo ip server 172.20.10.2, 192.168.1.67
...
$(function() {
    ...
    $("#datepickerI1").on("change", function () {
        ...
        var requestUrl = "http://" + ip + ":8000/dispenser/fake/?anno=" + year + "&mese=" + month + "&giorno=" + day + "";
...
function dataAvailableS(){
    ...
    $.get(requestUrl, function (data) {
        ...
        if(data[0] == 0){
            ...
            window.location.href="http://" + ip + ":8000/dispenser/statistic/?id=0" + "&noData=0" + "&anno=" + yearS + "&mese=" + monthS + "&giorno=" + dayS + "&annoF=" + yearE + "&meseF=" + monthE + "&giornoF=" + '0' + dayE + "";
        }
    }); 
}
...
function dataAvailableM(){
    ...
    $.get(requestUrl, function (data) {
        ...
        if(data[0] == 0){
            ...
            window.location.href="http://" + ip + ":8000/dispenser/statistic/?id=1" + "&noData=0" + "&anno=" + yearS + "&mese=" + monthS + "&giorno=" + dayS + "&annoF=" + yearE + "&meseF=" + monthE + "&giornoF=" + '0' + dayE + "";
        }
    }); 
}
